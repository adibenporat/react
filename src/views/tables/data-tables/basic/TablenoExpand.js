...
// import VerticalTable from 'react-table-vertical-heading/src/App'
// import VerticalTable from 'react-table-vertical-heading/src'
...
// import minus from '@src/assets/images/icons/minus.png'
// import { ExpandButton } from 'mui-datatables'
// import BTable from 'react-bootstrap-table'

import { Label, Row, Col, Input, Table, Card, CardHeader, CardTitle, CardBody } from 'reactstrap'
...
function App(props) {
  ...
  return (
    ...
    <Fragment>
      ...
      <Tables columns={columns} data={searchValue.length ? filteredData : props.data} sortBy={props.sortBy}
      />
      {/* } editable={true}/> */}
    </Fragment>
    // </Styles>
